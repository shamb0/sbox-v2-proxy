 ...
 */
abstract contract VRFConsumerBaseUpgrade is VRFRequestIDBase {
  ...
  // shamb0 :: Expriment on proxy-Upgrade ...
  ...
  function initVRFConsumerBase(address _vrfCoordinator, address _link) internal {
    vrfCoordinator = _vrfCoordinator;
    LINK = LinkTokenInterface(_link);
  }
